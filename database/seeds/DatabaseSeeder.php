...
class ArticleTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Article::create([
            'title' => 'Article 2',
            'html' => '<p>Wow Article 2: Nullam vel imperdiet dui. Cras mattis sapien mauris. Cras felis augue, dignissim fermentum interdum et, semper ut purus. Maecenas rutrum ac sem eu aliquet. Ut et mi laoreet, venenatis magna sed, commodo mauris. Maecenas orci elit, tempus et faucibus a, dapibus quis ex. Sed et velit vulputate, vestibulum metus vitae, luctus justo. Cras in finibus orci. In mattis neque quis ipsum efficitur finibus. Suspendisse vitae pellentesque justo. Quisque nec ligula lorem.</p>',
            'description' => 'asdf',
            'area' => 2,
            'page' => 1,
            'created_by' => 2,
        ...
        Article::create([
            'title' => 'Main Sticky',
            'description' => 'asdf',
            'html' => '<p>Everywhere message test</p>',
            'area' => 2,
            'page' => 0,
            'created_by' => 2,
            'modified_by' => 2
